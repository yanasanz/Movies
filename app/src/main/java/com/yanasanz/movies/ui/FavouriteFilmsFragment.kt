...
import com.yanasanz.movies.databinding.FragmentFavouriteFilmsBinding
...
class FavouriteFilmsFragment : Fragment() {
    private var binding: FragmentFavouriteFilmsBinding? = null
    ...
    override fun onCreateView(
        ...
        val binding = FragmentFavouriteFilmsBinding.inflate(inflater, container, false)
        ...
        adapter = FilmAdapter(object : FilmInteractionListener {
            ...
            override fun onOpenDetails(film: Film) {
                ...
                findNavController().navigate(
                    R.id.action_favouriteFilmsFragment_to_filmDetailsFragment,
                    bundle)
            }
        })

        binding.list.adapter = adapter
        viewModel.favourite.observe(viewLifecycleOwner) { films ->
